...
#kaplan-Meier~non parametric against all data
...
# based on the boxplot As there is no difference in the int call charge of the customers having intplan and with no int plan , the customers having the plan survival rate is low(low  customer satisfaction )
...
#Cox proportional method with numer of Calls
